<template>
  <div class="container-fluid page-body-wrapper">
      ...
      <div class="container mt-3">
        <div class="row">
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <p class="card-title float-left"><b>Kategori Pengaduan</b></p>
    ...
    <b-modal id="modalKategori" @ok="Save">
    ...
    getData : function(){
      ...
      .then(response => {
        if(response.data.success){
          ...
          this.$bvToast.hide("loadingToast");
          this.message = "Gagal menampilkan data kategori atau anda bukan admin"
